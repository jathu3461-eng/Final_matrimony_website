...
export const parsePhoneNumber = (fullNumber) => {
  ...
  // Sort by dial code length descending to match longest first (e.g. +971 before +9)
  ...
  // Clean up the local number (remove any non-digits, just in case, though E.164 is only digits and +)
